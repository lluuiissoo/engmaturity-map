...
### Selected option
Go with option 2 (tiered by criticality) combined with option 3 (org minimums). Define 3 tiers, set minimum floors, and you get a target matrix that's maybe 30 cells instead of 2,968 (106 repos x 28 sub-dimensions).
